...
class RemoteDatabaseManager {
    companion object{
        ...
        fun updateUserSubscriptionInRemoteDatabase(params: HashMap<String, String>, listener:OnUpdateListener){
        ...
        fun getAppDataFromRemoteDatabase(params: HashMap<String, String>, listener: OnQueryAppDataListener){
        ...
        fun checkAppVersionInRemoteDatabase(params: HashMap<String, String>, listener: OnQueryAppDataListener){
    ...
    interface RemoteDatabaseManagerInterface{
        fun signupUser(params: HashMap<String, String>, listener: OnSignupListener)
        fun updateUserSubscriptionInRemoteDatabase(params: HashMap<String, String>, listener:OnUpdateListener)
        fun getAppDataFromRemoteDatabase(params: HashMap<String, String>, listener: OnQueryAppDataListener)
        fun checkAppVersionInRemoteDatabase(params: HashMap<String, String>, listener: OnQueryAppDataListener)
